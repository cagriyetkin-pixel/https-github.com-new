...
| :--- | :--- | :--- |
| **[GA4 E-Commerce Funnel & Onboarding Analysis](https://github.com/cagriyetkin-pixel/ga4-ecommerce-funnel-bigquery)** | End-to-end user onboarding and conversion funnel performance analysis using GA4 event data. | BigQuery, Looker Studio |
